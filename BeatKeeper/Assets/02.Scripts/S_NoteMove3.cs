...
public class S_NoteMove3 : MonoBehaviour
{
    //Transform tr3;
    public float moveSpeed = 5f;
    public float rotSpeed = 5f;
    Transform S_MovePoint3;
    ...
    void Start()
    {
        S_MovePoint3 = GameObject.Find("S_Note End3").transform;
        DisTarget = GameObject.Find("S_EffectOn").transform;
    }

    void Update()
    {
            this.gameObject.transform.position = Vector3.MoveTowards(this.transform.position, S_MovePoint3.transform.position, Time.deltaTime * moveSpeed);
    }
